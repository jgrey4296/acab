...
class TypeContextQueryManager:
    ...
    def __post_init__(self):
        ...
        self.negated = NEGATION_S in typedef.data and typedef.data[NEGATION_S]
        constraints = [ConstraintCollection.build(x, operators=self.ctxs._operators) for x in typedef.structure]
