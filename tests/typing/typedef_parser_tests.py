...
import py_rule.typing.parsing.TypeDefParser as TD
import py_rule.typing.parsing.TypeParser as TP
...
class Trie_Fact_Parser_Tests(unittest.TestCase):
    ...
    def test_typedef_with_structure_types(self):
        result = TD.parseString('::blah:\n\na.b.c(::bloo)\n\nend')[0]
        self.assertEqual(result._structure[0][-1]._data[TU.TYPE_DEC_S]._name._value, 'bloo')
